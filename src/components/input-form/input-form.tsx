...
export const InputForm = () => {
    ...
    useEffect(() => {
        ...
        if (focusedElement) {
            focusedElement.focus(); // Устанавливаем фокус на найденном элементе
        }
                ...
                <fieldset className='fieldset-wrapper'>
                    ...
                    <div className="buttons-container">
                        <div className="buttons-row">
                            <button className={`button-usual ${focusedIndex === 1 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('1', e)}>1</button>
                            <button className={`button-usual ${focusedIndex === 2 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('2', e)}>2</button>
                            <button className={`button-usual ${focusedIndex === 3 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('3', e)}>3</button>
                        </div>
                        <div className="buttons-row">
                            <button className={`button-usual ${focusedIndex === 4 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('4', e)}>4</button>
                            <button className={`button-usual ${focusedIndex === 5 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('5', e)}>5</button>
                            <button className={`button-usual ${focusedIndex === 6 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('6', e)}>6</button>
                        </div>
                        <div className="buttons-row">
                            <button className={`button-usual ${focusedIndex === 7 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('7', e)}>7</button>
                            <button className={`button-usual ${focusedIndex === 8 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('8', e)}>8</button>
                            <button className={`button-usual ${focusedIndex === 9 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('9', e)}>9</button>
                        </div>
                        <div className="buttons-row">
                            <button className={`button-usual button-double ${focusedIndex === 10 ? 'focused' : ''}`} onClick={handleDeleteClick}>Стереть</button>
                            <button className={`button-usual ${focusedIndex === 11 ? 'focused' : ''}`} onClick={(e) => handleNumberClick('0', e)}>0</button>
                        </div>
                    </div>
                </fieldset>
            </form>
